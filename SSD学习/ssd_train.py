...
class SSDTrain(object):
    ...
    def __init__(self, num_classes=9, input_shape=(300, 300, 3), epochs=200):
    ...
    def get_detection_data(self):
        ...
        gen = Generator(gt, self.bbox_util, 16, self.image_path,
                        train_keys, val_keys,
                        (self.input_shape[0], self.input_shape[1]), do_crop=True)
    ...
    def fit_generator(self, gen):
        ...
        # 建立一回调函数
        callback = [
            ModelCheckpoint('./ckpt/fine_tuning/weights.{epoch:02d}-{val_loss:.2f}.hdf5',
                                            monitor='val_loss',
                                            save_best_only=True,
